...
const FAQS = [
  ...
  {
    q: "Zones et exclusivité",
    a: "Lorem ipsum dolores",
  },
  {
    q: "Délais d’installation",
    a: "Lorem ipsum dolores",
  },
  {
    q: "Investissement et royalties",
    a: "Lorem ipsum dolores",
  },
  {
    q: "Accompagnement à l’ouverture",
    a: "Lorem ipsum dolores",
  },
  ...
  return (
    <div className="mt-16 border-t border-white/[0.07] pt-14 md:mt-20 md:pt-16">
      ...
      <p className="mt-3 max-w-2xl text-[14px] font-light leading-relaxed text-cream/55">
        Réponses générales ; les engagements définitifs figurent uniquement aux
        contrats signés après due diligence.
      </p>
