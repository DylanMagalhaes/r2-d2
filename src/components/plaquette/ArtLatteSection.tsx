...
const DRINK_ICONS: readonly LucideIcon[] = [Coffee, Milk, Cookie, Sparkles];
      ...
      <div className="relative z-[1] mx-auto max-w-6xl">
        <div className="grid gap-6 md:grid-cols-12 md:items-end md:gap-8">
          <SectionHeader
            ...
            title={
              <>
                {a.titleBefore} <GoldAccent>{a.titleAccent}</GoldAccent>
              </>
            }
          />
          ...
          <div className="grid gap-10 lg:grid-cols-12 lg:gap-12 xl:gap-14">
            <div className="flex flex-col lg:col-span-5">
              ...
              <p className="text-[15px] font-light leading-[1.85] text-cream/66">
                {a.bodyBefore}{" "}
                <strong className="font-medium text-gold-pale">{a.bodyStrong}</strong>{" "}
                {a.bodyAfter}
              </p>
            ...
            <div className="flex flex-col divide-y divide-white/[0.06] lg:col-span-7">
              ...
              <div className="py-10 lg:py-11">
                <FieldLabel>{a.highlightsLabel}</FieldLabel>
                <ul
                  className="mt-5 grid gap-2 sm:grid-cols-2"
                  aria-label={a.highlightsAria}
                >
                  {a.highlights.map((label) => (
                    <li key={label}>
              ...
              <div className="py-10 lg:py-11">
                <FieldLabel>{a.creationsLabel}</FieldLabel>
                <ul className="mt-5 grid gap-2 sm:grid-cols-2">
                  {a.creations.map((label) => (
                    <li
                      key={label}
              ...
              <div className="pt-10 lg:pt-11">
                <FieldLabel>{a.usecasesLabel}</FieldLabel>
                <div className="mt-5 flex flex-wrap gap-2">
                  {a.usecases.map((label) => (
                    <span
                      key={label}
